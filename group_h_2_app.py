...
st.set_page_config(
    page_title="⚽ Group H Predictions | FIFA World Cup 2026",
...
<style>
  ...
  .hero-box{background:linear-gradient(135deg,#2a0000 0%,#3d0000 50%,#1a0a00 100%);
    border-radius:16px;padding:28px 32px;border:0.5px solid #7f1d1d;margin-bottom:24px;}
  ...
  .chip-red{background:#2e0d0d;color:#f56060;} .chip-crimson{background:#2e0d0d;color:#f87171;}
...
teams = {
    "Spain":        {"flag":"🇪🇸","rank":8, "conf":"UEFA",    "pts":9,"w":3,"d":0,"l":0,"color":"#ef4444","qualify":97,"elo":410,"form":88},
    "Uruguay":      {"flag":"🇺🇾","rank":14,"conf":"CONMEBOL","pts":6,"w":2,"d":0,"l":1,"color":"#60a5fa","qualify":80,"elo":150,"form":75},
    "Cabo Verde":   {"flag":"🇨🇻","rank":65,"conf":"CAF",     "pts":3,"w":1,"d":0,"l":2,"color":"#22a84a","qualify":22,"elo":6,  "form":58},
    "Saudi Arabia": {"flag":"🇸🇦","rank":53,"conf":"AFC",     "pts":0,"w":0,"d":0,"l":3,"color":"#f5c842","qualify":4, "elo":-62,"form":42},
}
matches = [
    {"md":1,"date":"Jun 15","home":"Spain",        "away":"Cabo Verde",   "hw":99.9,"d":0.1,"aw":0.0,"score":"3-0","conf":"Very High","stadium":"Mercedes-Benz Stadium, Atlanta",  "h_elo":410,"a_elo":6,  "h_form":88,"a_form":58,"h_rank":8, "a_rank":65},
    {"md":1,"date":"Jun 15","home":"Saudi Arabia", "away":"Uruguay",      "hw":0.1, "d":0.1,"aw":99.8,"score":"0-2","conf":"Very High","stadium":"Hard Rock Stadium, Miami",       "h_elo":-62,"a_elo":150,"h_form":42,"a_form":75,"h_rank":53,"a_rank":14},
    {"md":2,"date":"Jun 19","home":"Spain",        "away":"Uruguay",      "hw":99.7,"d":0.2,"aw":0.1,"score":"2-0","conf":"Very High","stadium":"Lumen Field, Seattle",            "h_elo":410,"a_elo":150,"h_form":88,"a_form":75,"h_rank":8, "a_rank":14},
    {"md":2,"date":"Jun 19","home":"Cabo Verde",   "away":"Saudi Arabia", "hw":99.6,"d":0.3,"aw":0.1,"score":"2-0","conf":"Very High","stadium":"AT&T Stadium, Arlington",         "h_elo":6,  "a_elo":-62,"h_form":58,"a_form":42,"h_rank":65,"a_rank":53},
    {"md":3,"date":"Jun 23","home":"Spain",        "away":"Saudi Arabia", "hw":99.9,"d":0.1,"aw":0.0,"score":"3-0","conf":"Very High","stadium":"SoFi Stadium, Inglewood",         "h_elo":410,"a_elo":-62,"h_form":88,"a_form":42,"h_rank":8, "a_rank":53},
    {"md":3,"date":"Jun 23","home":"Uruguay",      "away":"Cabo Verde",   "hw":99.7,"d":0.2,"aw":0.1,"score":"2-0","conf":"Very High","stadium":"MetLife Stadium, East Rutherford","h_elo":150,"a_elo":6,  "h_form":75,"a_form":58,"h_rank":14,"a_rank":65},
]
strength = {
    "Spain":        {"Attack":94,"Defence":90,"Form":88,"Elo Rating":99,"FIFA Rank":94,"Goal Diff":96},
    "Uruguay":      {"Attack":80,"Defence":80,"Form":75,"Elo Rating":78,"FIFA Rank":90,"Goal Diff":82},
    "Cabo Verde":   {"Attack":58,"Defence":58,"Form":58,"Elo Rating":42,"FIFA Rank":45,"Goal Diff":55},
    "Saudi Arabia": {"Attack":52,"Defence":48,"Form":42,"Elo Rating":28,"FIFA Rank":52,"Goal Diff":40},
}
sim_data = {
    "Spain":        {"1st":92,"2nd":7, "3rd":0,"elim":1},
    "Uruguay":      {"1st":7, "2nd":72,"3rd":8,"elim":13},
    "Cabo Verde":   {"1st":1, "2nd":18,"3rd":15,"elim":66},
    "Saudi Arabia": {"1st":0, "2nd":1, "3rd":0, "elim":99},
}
models_perf = {
    "XGBoost":        99.8,
    "LightGBM":       99.8,
...
weight_table = [
    ("⭐⭐⭐⭐⭐","Elo Difference",     "Spain +410 — highest Elo of any team across all 8 WC2026 groups"),
    ("⭐⭐⭐⭐⭐","Recent Form Score",  "Spain 88/100 — highest in Group H, 2nd highest in the full tournament"),
    ("⭐⭐⭐⭐", "FIFA Ranking",       "Spain #8, Uruguay #14 — both ranked above group opponents"),
    ("⭐⭐⭐⭐", "Goal Difference",    "Cabo Verde Elo +6 vs Saudi Arabia -62 — explains the upset prediction"),
    ("⭐⭐⭐⭐", "Avg Goals L5",      "Spain 2.8 GF / 0.4 GA — most dominant scoring plus defensive combo"),
    ("⭐⭐⭐",  "Days Rest",          "Cabo Verde travels Atlanta to Arlington in 4 days — tight turnaround"),
    ("⭐⭐⭐⭐", "Competitive Flag",  "Spain Nations League and Euro 2024 appearances heavily weighted"),
    ("⭐⭐⭐⭐", "Avg Goals Conceded","Saudi Arabia 2.4 GA/game — worst defensive record in the group"),
]
ACCENT = "#ef4444"
...
c1.markdown(f'<div class="metric-card"><div class="metric-lbl">🏆 Predicted Winner</div><div class="metric-num" style="color:{ACCENT}">Spain</div></div>',unsafe_allow_html=True)
...
c3.markdown('<div class="metric-card"><div class="metric-lbl">⚡ Highest Elo Ever</div><div class="metric-num" style="color:#f5c842">+410</div></div>',unsafe_allow_html=True)
c4.markdown('<div class="metric-card"><div class="metric-lbl">🔥 Shock Result</div><div class="metric-num" style="color:#22a84a" style="font-size:24px">Cabo Verde</div></div>',unsafe_allow_html=True)
...
with tabs[0]:
    ...
    st.markdown("""<div class="notice">🔑 Spain Elo +410 is the highest of any team across all 8 WC2026 groups.
    The big surprise: Cabo Verde beats Saudi Arabia in MD2 — their positive Elo +6 vs Saudi Arabia -62 confirms
    Cabo Verde have been beating stronger opponents recently. Saudi Arabia Elo -62 signals they have been outclassed.</div>""",unsafe_allow_html=True)
...
with tabs[1]:
    ...
    for m in matches:
        ...
        shock = '<span class="chip chip-green">🔥 Shock result predicted!</span>' if ht=="Cabo Verde" and at=="Saudi Arabia" else ""
        st.markdown(f"""
        <div class="match-card">
          ...
          <div style="display:flex;gap:8px;margin-bottom:10px;text-align:center;">
            <div style="flex:1;background:#2e0d0d;border:0.5px solid #7f1d1d;border-radius:8px;padding:10px 6px;">
              <div style="font-size:20px;font-weight:700;color:#f87171">{hw}%</div>
            ...
            <div style="flex:1;background:#2e0d0d;border:0.5px solid #7f1d1d;border-radius:8px;padding:10px 6px;">
              <div style="font-size:20px;font-weight:700;color:#f87171">{aw}%</div>
          ...
          {win_chip} <span class="chip chip-gold">Confidence: {m['conf']}</span> {shock}
        </div>""", unsafe_allow_html=True)
...
with tabs[2]:
    ...
    for team,d in strength.items():
        ...
        with st.expander(f"{td['flag']}  {team}  ·  FIFA #{td['rank']}  ·  Elo {elo_sign}{td['elo']}  ·  Form {td['form']}/100",expanded=(team=="Spain")):
...
with tabs[3]:
    ...
    for i,(team,s) in enumerate(sim_data.items()):
        ...
        chip_html = (f'<span class="chip chip-crimson">✅ Advances</span>' if qual_total > 70 else
    ...
    st.markdown("""<div class="match-card">
      ...
      <div style="font-size:13px;color:#9ca3af;line-height:1.9">
        🇪🇸 <strong style="color:#fff">Spain are the tournament-wide Elo leaders</strong> — +410 is the highest Elo of
        any team across all 8 groups. Form 88/100. Perfect 9-point sweep predicted.<br>
        🇨🇻 <strong style="color:#fff">Cabo Verde's shock win over Saudi Arabia</strong> — Despite being ranked #65,
        Cabo Verde's Elo is +6 while Saudi Arabia's is -62. A 68-point Elo gap in Cabo Verde's favour
        makes this upset very logical when Elo carries 5x weight.<br>
        🇺🇾 <strong style="color:#fff">Uruguay solidly 2nd</strong> — Elo +150 and Form 75/100. They lose to Spain
        but beat Saudi Arabia convincingly. Their South American pedigree and qualifying record is captured in the model.
      </div></div>""",unsafe_allow_html=True)
...
with tabs[4]:
    ...
    and Avg Goals carry 4x weight. Lower-weight features carry 1–2x weight only.
