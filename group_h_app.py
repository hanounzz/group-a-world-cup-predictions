...
st.set_page_config(page_title="⚽ Group H Predictions | FIFA World Cup 2026", page_icon="⚽", layout="wide", initial_sidebar_state="collapsed")
...
<style>
  ...
  .hero-box{{background:linear-gradient(135deg,#2a0000 0%,#3d0000 50%,#1a0a00 100%);border-radius:16px;padding:28px 32px;border:0.5px solid #7f1d1d;margin-bottom:24px;}}
  .hero-eyebrow{{font-size:11px;letter-spacing:.1em;color:#f87171;text-transform:uppercase;margin-bottom:4px;}}
  .hero-title{{font-size:32px;font-weight:700;color:#fff;margin-bottom:6px;}}
  .hero-sub{{font-size:14px;color:#fca5a5;}}
  ...
  .pos-badge{{width:28px;height:28px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:13px;font-weight:600;flex-shrink:0;}}
  ...
  .stTabs [aria-selected="true"]{{background:#1f2937 !important;color:#ef4444 !important;font-weight:600;}}
  ...
  .notice{{font-size:12px;color:#6b7280;background:#111827;border-radius:10px;padding:10px 14px;margin-top:16px;line-height:1.7;border:0.5px solid #1f2937;}}
...
teams = {'Spain': {'flag': '🇪🇸', 'rank': 8, 'conf': 'UEFA', 'pts': 9, 'w': 3, 'd': 0, 'l': 0, 'color': '#ef4444', 'qualify': 97, 'elo': 410, 'form': 88}, 'Uruguay': {'flag': '🇺🇾', 'rank': 14, 'conf': 'CONMEBOL', 'pts': 6, 'w': 2, 'd': 0, 'l': 1, 'color': '#60a5fa', 'qualify': 80, 'elo': 150, 'form': 75}, 'Cabo Verde': {'flag': '🇨🇻', 'rank': 65, 'conf': 'CAF', 'pts': 3, 'w': 1, 'd': 0, 'l': 2, 'color': '#22a84a', 'qualify': 22, 'elo': 6, 'form': 58}, 'Saudi Arabia': {'flag': '🇸🇦', 'rank': 53, 'conf': 'AFC', 'pts': 0, 'w': 0, 'd': 0, 'l': 3, 'color': '#f5c842', 'qualify': 4, 'elo': -62, 'form': 42}}
matches = [{'md': 1, 'date': 'Jun 15', 'home': 'Spain', 'away': 'Cabo Verde', 'hw': 99.9, 'd': 0.1, 'aw': 0.0, 'score': '3-0', 'conf': 'Very High', 'stadium': 'Mercedes-Benz Stadium, Atlanta', 'h_elo': 410, 'a_elo': 6, 'h_form': 88, 'a_form': 58, 'h_rank': 8, 'a_rank': 65}, {'md': 1, 'date': 'Jun 15', 'home': 'Saudi Arabia', 'away': 'Uruguay', 'hw': 0.1, 'd': 0.1, 'aw': 99.8, 'score': '0-2', 'conf': 'Very High', 'stadium': 'Hard Rock Stadium, Miami', 'h_elo': -62, 'a_elo': 150, 'h_form': 42, 'a_form': 75, 'h_rank': 53, 'a_rank': 14}, {'md': 2, 'date': 'Jun 19', 'home': 'Spain', 'away': 'Uruguay', 'hw': 99.7, 'd': 0.2, 'aw': 0.1, 'score': '2-0', 'conf': 'Very High', 'stadium': 'Lumen Field, Seattle', 'h_elo': 410, 'a_elo': 150, 'h_form': 88, 'a_form': 75, 'h_rank': 8, 'a_rank': 14}, {'md': 2, 'date': 'Jun 19', 'home': 'Cabo Verde', 'away': 'Saudi Arabia', 'hw': 99.6, 'd': 0.3, 'aw': 0.1, 'score': '2-0', 'conf': 'Very High', 'stadium': 'AT&T Stadium, Arlington', 'h_elo': 6, 'a_elo': -62, 'h_form': 58, 'a_form': 42, 'h_rank': 65, 'a_rank': 53}, {'md': 3, 'date': 'Jun 23', 'home': 'Spain', 'away': 'Saudi Arabia', 'hw': 99.9, 'd': 0.1, 'aw': 0.0, 'score': '3-0', 'conf': 'Very High', 'stadium': 'SoFi Stadium, Inglewood', 'h_elo': 410, 'a_elo': -62, 'h_form': 88, 'a_form': 42, 'h_rank': 8, 'a_rank': 53}, {'md': 3, 'date': 'Jun 23', 'home': 'Uruguay', 'away': 'Cabo Verde', 'hw': 99.7, 'd': 0.2, 'aw': 0.1, 'score': '2-0', 'conf': 'Very High', 'stadium': 'MetLife Stadium, East Rutherford', 'h_elo': 150, 'a_elo': 6, 'h_form': 75, 'a_form': 58, 'h_rank': 14, 'a_rank': 65}]
strength = {'Spain': {'Attack': 94, 'Defence': 90, 'Form': 88, 'Elo Rating': 99, 'FIFA Rank': 94, 'Goal Diff': 96}, 'Uruguay': {'Attack': 80, 'Defence': 80, 'Form': 75, 'Elo Rating': 78, 'FIFA Rank': 90, 'Goal Diff': 82}, 'Cabo Verde': {'Attack': 58, 'Defence': 58, 'Form': 58, 'Elo Rating': 42, 'FIFA Rank': 45, 'Goal Diff': 55}, 'Saudi Arabia': {'Attack': 52, 'Defence': 48, 'Form': 42, 'Elo Rating': 28, 'FIFA Rank': 52, 'Goal Diff': 40}}
sim_data = {'Spain': {'1st': 92, '2nd': 7, '3rd': 0, 'elim': 1}, 'Uruguay': {'1st': 7, '2nd': 72, '3rd': 8, 'elim': 13}, 'Cabo Verde': {'1st': 1, '2nd': 18, '3rd': 15, 'elim': 66}, 'Saudi Arabia': {'1st': 0, '2nd': 1, '3rd': 0, 'elim': 99}}
models_perf = {'XGBoost': 99.8, 'LightGBM': 99.8, 'ExtraTrees': 100.0, 'Random Forest': 100.0, 'SVM': 100.0, 'MLP': 99.6}
weight_table = [('⭐⭐⭐⭐⭐', 'Elo Difference', 'Spain +410 — the highest Elo in the entire WC2026 tournament'), ('⭐⭐⭐⭐⭐', 'Recent Form Score', 'Spain 88/100 — highest in Group H, 2nd highest tournament-wide'), ('⭐⭐⭐⭐', 'FIFA Ranking', 'Spain #8, Uruguay #14 — both ranked above group opponents'), ('⭐⭐⭐⭐', 'Goal Difference', 'Cabo Verde Elo +6 vs Saudi Arabia -62 — explains the Cabo Verde win'), ('⭐⭐⭐⭐', 'Avg Goals L5', 'Spain 2.8 GF / 0.4 GA — most dominant combo in all 8 groups'), ('⭐⭐⭐', 'Days Rest', 'Cabo Verde travels Atlanta to Arlington in 4 days — slight fatigue factor'), ('⭐⭐⭐⭐', 'Competitive Flag', 'Spain Nations League and Euro 2024 appearances heavily weighted'), ('⭐⭐⭐⭐', 'Avg Goals Conceded', 'Saudi Arabia 2.4 GA/game — worst defensive record in the group')]
WINNER_NOTE = "Spain Elo +410 is the highest of any team across all 8 WC2026 groups. The big surprise: Cabo Verde beats Saudi Arabia in MD2 — their Elo (+6 vs -62) confirms Cabo Verde have beaten stronger opponents recently. Saudi Arabia -62 Elo signals they have been outclassed."
GROUP = "H"
...
<div class="hero-box">
  ...
  <div class="hero-title">⚽ Group H Predictions</div>
  <div class="hero-sub">Spain · Uruguay · Cabo Verde · Saudi Arabia &nbsp;|&nbsp; 6 Matches · 3 Matchdays</div>
...
for col,(label,val,color) in zip([c1,c2,c3,c4],[
    ("🏆 Predicted Winner",WINNER,ACCENT),
    ("✅ Best Accuracy","100%","#22a84a"),
    ("📊 Features Used","18+","#f5c842"),
    ("⚡ ML Models","6","#60aef5")]):
    col.markdown(f'<div class="metric-card"><div class="metric-lbl">{{label}}</div>'
                 f'<div class="metric-num" style="color:{{color}};font-size:{{"28px" if len(val)>8 else "36px"}}">{{val}}</div></div>',unsafe_allow_html=True)
...
with tabs[0]:
    ...
    with cr:
        fig2=go.Figure(go.Bar(x=list(teams.keys()),y=[d["elo"] for d in teams.values()],
            ...
            marker_line_width=0,text=[f"{{chr(43) if d['elo']>=0 else ''}}{{d['elo']}}" for d in teams.values()],
            textposition="outside",textfont=dict(color="#e8eaf0",size=12)))
        fig2.update_layout(title=dict(text="Elo Difference (5x weight)",font=dict(color="#fff",size=14)),
            paper_bgcolor=CHART_BG,plot_bgcolor=CHART_BG,showlegend=False,height=280,
            yaxis=dict(gridcolor=GRID_CLR,tickcolor=TICK_CLR,color=TICK_CLR),
            xaxis=dict(gridcolor=GRID_CLR,tickcolor=TICK_CLR,color=TICK_CLR),margin=dict(l=20,r=20,t=40,b=20))
        st.plotly_chart(fig2,use_container_width=True)
    st.markdown('<div class="notice">Spain Elo +410 is the highest of any team across all 8 WC2026 groups. Cabo Verde beats Saudi Arabia in MD2 — Elo +6 vs -62 confirms this. Saudi Arabia Elo -62 signals elimination.</div>', unsafe_allow_html=True)
...
with tabs[1]:
    ...
    for m in matches:
        if m["md"]!=prev_md:
            prev_md=m["md"]
            st.markdown(f'<div class="section-lbl">Matchday {{m["md"]}}</div>',unsafe_allow_html=True)
        ht,at=m["home"],m["away"]
        ...
        <div class="match-card">
          ...
          <div style="display:flex;gap:8px;margin-bottom:10px;text-align:center;">
            <div style="flex:1;background:#1a1010;border:0.5px solid #3a1010;border-radius:8px;padding:10px 6px;">
              <div style="font-size:20px;font-weight:700;color:{{acc}}">{{hw}}%</div>
            ...
            <div style="flex:1;background:#1a1010;border:0.5px solid #3a1010;border-radius:8px;padding:10px 6px;">
              <div style="font-size:20px;font-weight:700;color:{{acc}}">{{aw}}%</div>
...
with tabs[2]:
    cats=list(list(strength.values())[0].keys())
    fig_r=go.Figure()
    ...
    for team,d in strength.items():
        td=teams[team]
        with st.expander(f"{{td['flag']}}  {{team}}  · FIFA #{{td['rank']}}  · Elo {{chr(43) if td['elo']>=0 else ''}}{{td['elo']}}  · Form {{td['form']}}/100",expanded=(list(teams.keys()).index(team)==0)):
...
with tabs[3]:
    ...
    for i,(team,s) in enumerate(sim_data.items()):
        ...
        qual_color=acc if qual_total>70 else("#f5c842" if qual_total>20 else "#f56060")
        ...
        elo_disp=f"+{{td['elo']}}" if td["elo"]>=0 else str(td["elo"])
        with col:
            st.markdown(f"""
            <div class="match-card" style="margin-bottom:12px">
              ...
              <div style="font-size:11px;color:#6b7280;margin-bottom:12px">
                FIFA #{{td['rank']}} · Elo {{elo_disp}} · Form {{td['form']}}/100</div>
...
with tabs[4]:
    ...
    acc="#ef4444"
    c1.markdown(f'<div class="metric-card"><div class="metric-lbl">🏆 Best Model</div><div class="metric-num" style="color:{{acc}}">100%</div><div style="font-size:11px;color:#6b7280;margin-top:4px">⭐⭐⭐⭐⭐ Perfect</div></div>',unsafe_allow_html=True)
    ...
    c3.markdown('<div class="metric-card"><div class="metric-lbl">📊 Total Metrics</div><div class="metric-num" style="color:#22a84a">18+</div><div style="font-size:11px;color:#6b7280;margin-top:4px">All weighted</div></div>',unsafe_allow_html=True)
    st.markdown("<br>",unsafe_allow_html=True)
    ...
    fig_m=go.Figure(go.Bar(y=list(models_perf.keys()),x=list(models_perf.values()),orientation="h",
        marker_color=[acc if v>=99.5 else "#f5c842" for v in models_perf.values()],
    ...
    fig_m.update_layout(title=dict(text="All 6 Prediction Engines — Accuracy",font=dict(color="#fff",size=14)),
        ...
        xaxis=dict(range=[94,102],gridcolor=GRID_CLR,tickcolor=TICK_CLR,color=TICK_CLR,ticksuffix="%"),
    ...
    st.markdown('''<div class="notice">⚠️ Predictions use all 18+ available metrics weighted by predictive importance. Elo Difference and Recent Form Score carry 5x weight each. FIFA Ranking, Goal Difference, Competitive Match Flag and Avg Goals carry 4x weight. Lower-weight features carry 1-2x weight only. Football is unpredictable.</div>''',unsafe_allow_html=True)

st.markdown("""<br>
<div style="text-align:center;font-size:11px;color:#374151;padding:16px 0;border-top:0.5px solid #1f2937;">
  ⚽ FIFA World Cup 2026 · Group H Predictor (Weighted All-Metrics) &nbsp;|&nbsp; Machine Learning &amp; Match Data &nbsp;|&nbsp; For fans, by fans
</div>""",unsafe_allow_html=True)
