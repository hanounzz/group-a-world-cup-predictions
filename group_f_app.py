...
st.set_page_config(page_title="⚽ Group F Predictions | FIFA World Cup 2026", page_icon="⚽", layout="wide", initial_sidebar_state="collapsed")
...
<style>
  ...
  .hero-box{{background:linear-gradient(135deg,#2a0d00 0%,#3d1a00 50%,#1a0a00 100%);border-radius:16px;padding:28px 32px;border:0.5px solid #7c2d12;margin-bottom:24px;}}
...
teams = {'Netherlands': {'flag': '🇳🇱', 'rank': 7, 'conf': 'UEFA', 'pts': 9, 'w': 3, 'd': 0, 'l': 0, 'color': '#f97316', 'qualify': 97, 'elo': 276, 'form': 80}, 'Japan': {'flag': '🇯🇵', 'rank': 18, 'conf': 'AFC', 'pts': 4, 'w': 1, 'd': 1, 'l': 1, 'color': '#ef4444', 'qualify': 55, 'elo': 88, 'form': 72}, 'Sweden': {'flag': '🇸🇪', 'rank': 28, 'conf': 'UEFA', 'pts': 4, 'w': 1, 'd': 1, 'l': 1, 'color': '#facc15', 'qualify': 55, 'elo': 81, 'form': 70}, 'Tunisia': {'flag': '🇹🇳', 'rank': 41, 'conf': 'CAF', 'pts': 0, 'w': 0, 'd': 0, 'l': 3, 'color': '#e5e7eb', 'qualify': 4, 'elo': -52, 'form': 48}}
matches = [{'md': 1, 'date': 'Jun 14', 'home': 'Netherlands', 'away': 'Japan', 'hw': 99.7, 'd': 0.2, 'aw': 0.1, 'score': '2-1', 'conf': 'Very High', 'stadium': 'AT&T Stadium, Arlington', 'h_elo': 276, 'a_elo': 88, 'h_form': 80, 'a_form': 72, 'h_rank': 7, 'a_rank': 18}, {'md': 1, 'date': 'Jun 14', 'home': 'Sweden', 'away': 'Tunisia', 'hw': 99.8, 'd': 0.1, 'aw': 0.1, 'score': '2-0', 'conf': 'Very High', 'stadium': 'Estadio BBVA, Monterrey', 'h_elo': 81, 'a_elo': -52, 'h_form': 70, 'a_form': 48, 'h_rank': 28, 'a_rank': 41}, {'md': 2, 'date': 'Jun 18', 'home': 'Netherlands', 'away': 'Sweden', 'hw': 99.8, 'd': 0.1, 'aw': 0.1, 'score': '2-0', 'conf': 'Very High', 'stadium': 'SoFi Stadium, Inglewood', 'h_elo': 276, 'a_elo': 81, 'h_form': 80, 'a_form': 70, 'h_rank': 7, 'a_rank': 28}, {'md': 2, 'date': 'Jun 18', 'home': 'Japan', 'away': 'Tunisia', 'hw': 99.8, 'd': 0.1, 'aw': 0.1, 'score': '2-0', 'conf': 'Very High', 'stadium': 'Lumen Field, Seattle', 'h_elo': 88, 'a_elo': -52, 'h_form': 72, 'a_form': 48, 'h_rank': 18, 'a_rank': 41}, {'md': 3, 'date': 'Jun 22', 'home': 'Netherlands', 'away': 'Tunisia', 'hw': 99.9, 'd': 0.1, 'aw': 0.0, 'score': '3-0', 'conf': 'Very High', 'stadium': 'Hard Rock Stadium, Miami', 'h_elo': 276, 'a_elo': -52, 'h_form': 80, 'a_form': 48, 'h_rank': 7, 'a_rank': 41}, {'md': 3, 'date': 'Jun 22', 'home': 'Japan', 'away': 'Sweden', 'hw': 0.2, 'd': 99.6, 'aw': 0.2, 'score': '1-1', 'conf': 'Very High', 'stadium': 'NRG Stadium, Houston', 'h_elo': 88, 'a_elo': 81, 'h_form': 72, 'a_form': 70, 'h_rank': 18, 'a_rank': 28}]
strength = {'Netherlands': {'Attack': 90, 'Defence': 85, 'Form': 80, 'Elo Rating': 98, 'FIFA Rank': 95, 'Goal Diff': 90}, 'Japan': {'Attack': 76, 'Defence': 74, 'Form': 72, 'Elo Rating': 65, 'FIFA Rank': 85, 'Goal Diff': 72}, 'Sweden': {'Attack': 72, 'Defence': 72, 'Form': 70, 'Elo Rating': 62, 'FIFA Rank': 78, 'Goal Diff': 68}, 'Tunisia': {'Attack': 55, 'Defence': 55, 'Form': 48, 'Elo Rating': 30, 'FIFA Rank': 62, 'Goal Diff': 45}}
sim_data = {'Netherlands': {'1st': 88, '2nd': 11, '3rd': 0, 'elim': 1}, 'Japan': {'1st': 6, '2nd': 40, '3rd': 12, 'elim': 42}, 'Sweden': {'1st': 6, '2nd': 40, '3rd': 12, 'elim': 42}, 'Tunisia': {'1st': 0, '2nd': 1, '3rd': 0, 'elim': 99}}
models_perf = {'XGBoost': 100.0, 'LightGBM': 100.0, 'ExtraTrees': 100.0, 'Random Forest': 100.0, 'SVM': 100.0, 'MLP': 96.0}
weight_table = [('⭐⭐⭐⭐⭐', 'Elo Difference', 'Netherlands +276 — highest Elo in Group F'), ('⭐⭐⭐⭐⭐', 'Recent Form Score', 'Netherlands 80, Japan 72, Sweden 70 — tight competition for 2nd'), ('⭐⭐⭐⭐', 'FIFA Ranking', 'Netherlands #7 but Japan and Sweden Elo gap of 7 drives the draw'), ('⭐⭐⭐⭐', 'Goal Difference', 'Japan +1.6/game, Sweden +1.4/game — nearly identical, confirms draw'), ('⭐⭐⭐⭐', 'Avg Goals L5', 'Netherlands 2.8 GF/game — consistent scoring across all 5 recent matches'), ('⭐⭐⭐', 'Days Rest', 'Japan vs Sweden MD3 with identical rest days — total balance, hence draw'), ('⭐⭐⭐⭐', 'Competitive Flag', 'Japan WC qualifier wins against strong AFC teams weighted heavily'), ('⭐⭐⭐⭐', 'Avg Goals Conceded', 'Tunisia 2.2 GA/game — explains 3 consecutive losses to all opponents')]
WINNER_NOTE = "Netherlands Elo +276 is the highest in Group F. Japan and Sweden Elo values (+88 vs +81) and form scores (72 vs 70) are nearly identical — that statistical closeness drives the draw prediction in MD3. Tunisia Elo -52 confirms elimination."
GROUP = "F"
...
with tabs[0]:
    ...
    st.markdown('<div class="notice">Netherlands Elo +276 is the highest in Group F. Japan and Sweden Elo values are nearly identical — statistical closeness drives the MD3 draw. Tunisia Elo -52 confirms elimination.</div>', unsafe_allow_html=True)
