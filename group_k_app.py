...
st.set_page_config(
    page_title="⚽ Group K Predictions | FIFA World Cup 2026",
...
<style>
  ...
  .hero-box{background:linear-gradient(135deg,#00142a 0%,#001e3d 50%,#00100a 100%);
    border-radius:16px;padding:28px 32px;border:0.5px solid #003060;margin-bottom:24px;}
  .hero-eyebrow{font-size:11px;letter-spacing:.1em;color:#a78bfa;text-transform:uppercase;margin-bottom:4px;}
  .hero-title{font-size:32px;font-weight:700;color:#fff;margin-bottom:6px;}
  .hero-sub{font-size:14px;color:#c4b5fd;}
  ...
  .chip-purple{background:#1e1028;color:#a78bfa;} .chip-red{background:#2e0d0d;color:#f56060;}
  ...
  .stTabs [aria-selected="true"]{background:#1f2937 !important;color:#a78bfa !important;font-weight:600;}
...
teams = {
    "Portugal":   {"flag":"🇵🇹","rank":6, "conf":"UEFA",    "pts":9,"w":3,"d":0,"l":0,"color":"#ef4444","qualify":97,"elo":195,"form":42},
    "Colombia":   {"flag":"🇨🇴","rank":12,"conf":"CONMEBOL","pts":6,"w":2,"d":0,"l":1,"color":"#f5c842","qualify":78,"elo":66, "form":37},
    "Congo DR":   {"flag":"🇨🇩","rank":62,"conf":"CAF",     "pts":3,"w":1,"d":0,"l":2,"color":"#22a84a","qualify":18,"elo":10, "form":35},
    "Uzbekistan": {"flag":"🇺🇿","rank":64,"conf":"AFC",     "pts":0,"w":0,"d":0,"l":3,"color":"#a78bfa","qualify":4, "elo":-103,"form":30},
}
matches = [
    {"md":1,"date":"Jun 17","home":"Portugal",  "away":"Congo DR",  "hw":83.3,"d":15.0,"aw":1.7,"score":"2-1","conf":"Very High","stadium":"NRG Stadium, Houston",           "h_elo":195,"a_elo":10,  "h_form":42,"a_form":35,"h_rank":6, "a_rank":62},
    {"md":1,"date":"Jun 17","home":"Uzbekistan","away":"Colombia",  "hw":2.1, "d":19.0,"aw":78.9,"score":"1-2","conf":"High",    "stadium":"Estadio Azteca, Mexico City",    "h_elo":-103,"a_elo":66,"h_form":30,"a_form":37,"h_rank":64,"a_rank":12},
    {"md":2,"date":"Jun 21","home":"Portugal",  "away":"Colombia",  "hw":69.8,"d":27.2,"aw":3.0,"score":"3-2","conf":"High",    "stadium":"Levi's Stadium, Santa Clara",    "h_elo":195,"a_elo":66,  "h_form":42,"a_form":37,"h_rank":6, "a_rank":12},
    {"md":2,"date":"Jun 21","home":"Uzbekistan","away":"Congo DR",  "hw":3.5, "d":31.2,"aw":65.3,"score":"1-1","conf":"Medium", "stadium":"BMO Field, Toronto",             "h_elo":-103,"a_elo":10,"h_form":30,"a_form":35,"h_rank":64,"a_rank":62},
    {"md":3,"date":"Jun 25","home":"Portugal",  "away":"Uzbekistan","hw":98.7,"d":1.2, "aw":0.1,"score":"3-1","conf":"Very High","stadium":"AT&T Stadium, Arlington",        "h_elo":195,"a_elo":-103,"h_form":42,"a_form":30,"h_rank":6, "a_rank":64},
    {"md":3,"date":"Jun 25","home":"Colombia",  "away":"Congo DR",  "hw":63.5,"d":32.9,"aw":3.6,"score":"2-1","conf":"Medium",  "stadium":"SoFi Stadium, Inglewood",        "h_elo":66, "a_elo":10,  "h_form":37,"a_form":35,"h_rank":12,"a_rank":62},
]
strength = {
    "Portugal":   {"Attack":88,"Defence":84,"Form":78,"Elo Rating":88,"FIFA Rank":96,"Goal Diff":86},
    "Colombia":   {"Attack":72,"Defence":68,"Form":68,"Elo Rating":64,"FIFA Rank":90,"Goal Diff":66},
    "Congo DR":   {"Attack":55,"Defence":60,"Form":62,"Elo Rating":46,"FIFA Rank":45,"Goal Diff":54},
    "Uzbekistan": {"Attack":44,"Defence":44,"Form":52,"Elo Rating":18,"FIFA Rank":44,"Goal Diff":42},
}
sim_data = {
    "Portugal":   {"1st":88,"2nd":11,"3rd":0,"elim":1},
    "Colombia":   {"1st":11,"2nd":68,"3rd":8,"elim":13},
    "Congo DR":   {"1st":1, "2nd":18,"3rd":10,"elim":71},
    "Uzbekistan": {"1st":0, "2nd":1, "3rd":0, "elim":99},
}
models_perf = {"XGBoost":100.0,"LightGBM":100.0,"ExtraTrees":100.0,"Random Forest":100.0,"SVM":100.0,"MLP":96.8}
weight_table = [
    ("⭐⭐⭐⭐⭐","Elo Difference",     "Portugal +195 — 3rd highest Elo in the tournament. Uzbekistan -103 is the lowest in Group K"),
    ("⭐⭐⭐⭐⭐","Recent Form Score",  "Form on 0-10 scale in files — pipeline normalized to 0-100 (Portugal 42, Colombia 37)"),
    ("⭐⭐⭐⭐", "FIFA Ranking",       "Portugal #6, Colombia #12 — both elite ranking vs Uzbekistan #64"),
    ("⭐⭐⭐⭐", "Goal Difference",    "Portugal +2.4 GD/game — best in the group. Uzbekistan -0.4 — only negative GD"),
    ("⭐⭐⭐⭐", "Avg Goals Scored",   "Portugal 3.0 GF/game — highest in Group K. Colombia 1.8/game solid 2nd"),
    ("⭐⭐⭐",  "Days Rest",          "Portugal and Uzbekistan meet in MD3 after 8 days — equal rest"),
    ("⭐⭐⭐⭐", "Competitive Flag",   "Portugal Euro 2024, Nations League — full competitive match record"),
    ("⭐⭐⭐⭐", "Possession %",      "Portugal 58.6% — controls tempo. Uzbekistan 44.4% — lowest in group"),
]
ACCENT = "#a78bfa"
...
<div class="hero-box">
  ...
  <div class="hero-title">⚽ Group K Predictions</div>
  <div class="hero-sub">Portugal · Uzbekistan · Colombia · Congo DR &nbsp;|&nbsp; 6 Matches · 3 Matchdays</div>
</div>""", unsafe_allow_html=True)

c1,c2,c3,c4 = st.columns(4)
c1.markdown(f'<div class="metric-card"><div class="metric-lbl">🏆 Predicted Winner</div><div class="metric-num" style="color:#ef4444">Portugal</div></div>',unsafe_allow_html=True)
...
c3.markdown(f'<div class="metric-card"><div class="metric-lbl">⚡ Elo Gap</div><div class="metric-num" style="color:{ACCENT}">298 pts</div></div>',unsafe_allow_html=True)
c4.markdown('<div class="metric-card"><div class="metric-lbl">📊 Features Used</div><div class="metric-num" style="color:#f5c842">18+</div></div>',unsafe_allow_html=True)
...
with tabs[0]:
    ...
    st.markdown("""<div class="notice">🔑 Group K form data is on a 0-10 scale in the source file — the pipeline
    normalizes this to 0-100 before computing predictions. Portugal Elo +195 leads the group convincingly.
    The biggest gap: Portugal vs Uzbekistan is 298 Elo points, driving a 98.7% win probability in MD3.
    Congo DR's Elo +10 vs Uzbekistan -103 explains their predicted 3rd place finish.</div>""",unsafe_allow_html=True)
    ...
    for m in matches:
        ...
        <div class="match-card">
          ...
          <div style="display:flex;gap:8px;margin-bottom:10px;text-align:center;">
            <div style="flex:1;background:#1e1028;border:0.5px solid #4c2080;border-radius:8px;padding:10px 6px;">
              <div style="font-size:20px;font-weight:700;color:#a78bfa">{hw}%</div>
            ...
            <div style="flex:1;background:#1e1028;border:0.5px solid #4c2080;border-radius:8px;padding:10px 6px;">
              <div style="font-size:20px;font-weight:700;color:#a78bfa">{aw}%</div>
...
with tabs[2]:
    ...
    for team,d in strength.items():
        ...
        with st.expander(f"{td['flag']}  {team}  ·  FIFA #{td['rank']}  ·  Elo {elo_sign}{td['elo']}  ·  Form {td['form']}/100",expanded=(team=="Portugal")):
...
with tabs[3]:
    ...
    for i,(team,s) in enumerate(sim_data.items()):
        ...
        qual_color = "#ef4444" if team=="Portugal" else (ACCENT if qual_total > 70 else ("#f5c842" if qual_total > 20 else "#f56060"))
    ...
    st.markdown("""<div class="match-card">
      ...
      <div style="font-size:13px;color:#9ca3af;line-height:1.9">
        🇵🇹 <strong style="color:#fff">Portugal are Group K's dominant force</strong> — Elo +195, FIFA #6, 3.0 GF/game.
        Clean sweep of all 3 matchdays predicted with very high confidence.<br>
        🇨🇴 <strong style="color:#fff">Colombia solidly 2nd</strong> — FIFA #12 and Elo +66 places them clearly above Congo DR (+10)
        and Uzbekistan (-103). Colombia's 1.8 GF/game is healthy for 2nd place.<br>
        🇨🇩 <strong style="color:#fff">Congo DR earn 3rd</strong> — Elo +10 is 113 points above Uzbekistan's -103.
        They beat Uzbekistan in MD2 but fall to Portugal and Colombia. Best 3rd-place race is possible.
      </div></div>""",unsafe_allow_html=True)
...
with tabs[4]:
    ...
    st.markdown("""<div class="notice">⚠️ Group K form scores in the source file are on a 0-10 scale —
    the ML pipeline normalizes these by multiplying by 10 before computing the weighted composite score.
    All other groups use 0-100 scale. This is handled automatically.</div>""",unsafe_allow_html=True)

st.markdown("""<br>
<div style="text-align:center;font-size:11px;color:#374151;padding:16px 0;border-top:0.5px solid #1f2937;">
  ⚽ FIFA World Cup 2026 · Group K Predictor · Data from group_k_matches_history.xlsx &nbsp;|&nbsp; For fans, by fans
</div>""",unsafe_allow_html=True)
